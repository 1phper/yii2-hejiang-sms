...
class AliyunSender extends BaseSender implements SenderInterface
{
    public function send($phoneNumber, $tplId, $tplParams, $sign)
    {
        ...
        $responseRaw = $this->request($accessKeyId, $accessKeySecret, "dysmsapi.aliyuncs.com", array_merge($params, array("RegionId" => "cn-hangzhou", "Action" => "SendSms", "Version" => "2017-05-25")));
